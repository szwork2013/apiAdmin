...
require("../statics/less/birdie.less");
import AreaList from '../conf/AreaList'
...
const TreeNode = React.createClass({
    ...
    plus(event){
        ...
        var $newli = $("<li></li>").appendTo($treeNodes[0])
    ...
    getChildNode(treeNode,aniStyle){
        if(treeNode.id == 0){
            return (
                <div className={"tree-node tree-handle tree-node tree-node-content"}>
                    <a onClick={this.plus} className="pull-right btn btn-white btn-xs"><span className="fa fa-plus"></span></a>
        ...
        return (
            <div className={"tree-node tree-handle tree-node tree-node-content " + aniStyle}>
                <a onClick={this.trash} className="pull-right btn btn-white btn-xs"><span className="fa fa-trash"></span></a>
                <a onClick={this.plus} className="pull-right btn btn-white btn-xs"><span className="fa fa-plus"></span></a>
                <a onClick={this.props.edit} className="pull-right btn btn-white btn-xs"><span className="fa fa-edit"></span></a>
